...
('b2b2b2b2-0001-4000-8000-000000000001', 'Sultani Kehribar Tesbih', 'Tesbih', 'Kehribar',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/4/41/020240302_Amber_muslim_prayer_beads.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/4/41/020240302_Amber_muslim_prayer_beads.jpg',
...
('b2b2b2b2-0001-4000-8000-000000000001', 'Basra Kesim Kehribar Tesbih', 'Tesbih', 'Kehribar',
 ...
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/6/6f/Amber_Bead_-_YDEA_-_73870.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/7/72/Amber_Bead_-_YDEA_-_73871.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/8/8a/Gold_necklace_with_inlaid_amber_MET_19473.jpg'
...
('b2b2b2b2-0001-4000-8000-000000000001', 'Zümrüt Yeşili Sedef Tesbih', 'Tesbih', 'Sedef',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Ian_Rosenberg_Jeweller_%E2%80%93_Blue-toned_mother_of_pearl_shell_necklace.JPG',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/f/f0/Ian_Rosenberg_Jeweller_%E2%80%93_Blue-toned_mother_of_pearl_shell_necklace.JPG',
   'https://upload.wikimedia.org/wikipedia/commons/e/ed/Necklace_%28AM_674266-1%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/2/27/Necklace_%28AM_674266-4%29.jpg'
...
('b2b2b2b2-0001-4000-8000-000000000001', 'İnci Beyazı Sedef Tesbih', 'Tesbih', 'Sedef',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Necklace_%28AM_674266-2%29.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/9/9d/Necklace_%28AM_674266-2%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/e/ed/Necklace_LACMA_M.89.112.1.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/f/f0/Ian_Rosenberg_Jeweller_%E2%80%93_Blue-toned_mother_of_pearl_shell_necklace.JPG'
...
('b2b2b2b2-0002-4000-8000-000000000002', 'El Oyması Oltu Taşı Tesbih', 'Tesbih', 'Oltu Taşı',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Whitby_Jet_%2841837232445%29.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/0/0d/Whitby_Jet_%2841837232445%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/b/b6/Whitby_Jet_%2841837233025%29.jpg',
...
('b2b2b2b2-0002-4000-8000-000000000002', 'Püsküllü Oltu Taşı Tesbih (99''lu)', 'Tesbih', 'Oltu Taşı',
 ...
 ARRAY[
   ...
   'https://upload.wikimedia.org/wikipedia/commons/7/7b/Modern_jet_chain_link_%28section%29_%28FindID_289983%29.jpg'
...
('b2b2b2b2-0002-4000-8000-000000000002', 'Damarlı Akik Tesbih', 'Tesbih', 'Akik',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/2/26/Malawi_Agate_%28Malawi%2C_southeastern_Africa%29_%2832734668126%29.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/2/26/Malawi_Agate_%28Malawi%2C_southeastern_Africa%29_%2832734668126%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/d/d9/Modern_white_metal_and_layered_chalcedony_hinged_bracelet_%28FindID_1017837%29.jpg'
...
('b2b2b2b2-0002-4000-8000-000000000002', 'Kaplan Gözü Doğal Taş Tesbih', 'Tesbih', 'Kaplan Gözü',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/b/be/Tiger%27s_eye.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/b/be/Tiger%27s_eye.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/2/26/Malawi_Agate_%28Malawi%2C_southeastern_Africa%29_%2832734668126%29.jpg'
...
('b2b2b2b2-0003-4000-8000-000000000003', 'Gümüş Detaylı Klasik Tesbih', 'Tesbih', 'Gümüş',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Tasbih_or_prayer_beads.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/c/cf/Tasbih_or_prayer_beads.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/9/98/Qur%27an_and_tespih.jpg'
...
('b2b2b2b2-0003-4000-8000-000000000003', 'Zirkon Taşlı Gümüş Yüzük', 'Yüzük', 'Gümüş 925',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Flat_silver_ring_with_a_triangular_faceted_garnet_1.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/5/5e/Flat_silver_ring_with_a_triangular_faceted_garnet_1.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/8/80/Flat_silver_ring_with_a_triangular_faceted_garnet_2.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/4/46/Flat_silver_ring_with_a_triangular_faceted_garnet_3.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/b/b9/Flat_silver_ring_with_a_triangular_faceted_garnet_4.jpg'
...
('b2b2b2b2-0003-4000-8000-000000000003', 'Sade Gümüş Alyans Model Yüzük', 'Yüzük', 'Sade',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/1/17/Silver_ring_and_scorzoneras_by_ASQ.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/1/17/Silver_ring_and_scorzoneras_by_ASQ.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/7/77/Silver_ring_and_spaghetti_by_ASQ.jpg'
...
('b2b2b2b2-0003-4000-8000-000000000003', '14 Ayar Altın Kaplama İnce Yüzük', 'Yüzük', 'Altın',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/d/df/Gold_wedding_ring.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/d/df/Gold_wedding_ring.jpg',
...
('b2b2b2b2-0004-4000-8000-000000000004', 'Firuze Taşlı Otantik Gümüş Yüzük', 'Yüzük', 'Firuze',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/a/a0/Silver_and_turquoise_rings.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/a/a0/Silver_and_turquoise_rings.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/6/6d/Turquoise_and_silver_rings.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/a/a5/Ring_with_turquoise_MET_sf74514259.jpg'
...
('b2b2b2b2-0004-4000-8000-000000000004', 'İkili Firuze Taşlı Yüzük', 'Yüzük', 'Firuze',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/6/6d/SILVER_AND_TURQUOISE_JEWELLERY_SET_%28Hunt_Museum%29.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/6/6d/SILVER_AND_TURQUOISE_JEWELLERY_SET_%28Hunt_Museum%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/a/a0/Silver_and_turquoise_rings.jpg'
...
('b2b2b2b2-0005-4000-8000-000000000005', 'Hindistan Sandal Ağacı Tesbih', 'Tesbih', 'Sandal Ağacı',
 ...
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/c/cf/Tasbih_or_prayer_beads.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/9/98/Qur%27an_and_tespih.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/5/50/Muslim_Holding_a_Prayer_Counter_While_Performing_Tasbih.jpg'
...
('b2b2b2b2-0005-4000-8000-000000000005', 'Ceviz Ağacı Damarlı Tesbih', 'Tesbih', 'Ceviz Ağacı',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Texture_de_noyer.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/9/9c/Texture_de_noyer.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/7/7f/Muslim_in_White_Jallabiya_Reading_the_Qur%E2%80%99an_with_Tasbih_in_Hand.jpg'
...
('b2b2b2b2-0005-4000-8000-000000000005', 'Pirinç İşlemeli Osmanlı Tesbih', 'Tesbih', 'Pirinç',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Local_Brass_Bracelet.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/0/0e/Local_Brass_Bracelet.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/1/11/Local_Brass_Bracelet_II.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/b/b1/WLA_brooklynmuseum_Ainu_Tamasay_Bead_Necklace.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'Zümrüt Taşlı Vintage Yüzük', 'Yüzük', 'Zümrüt Kesim',
 ...
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/1/1e/Medieval_emerald_ring.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/5/54/Emerald_and_diamond_ring.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'Zümrüt Yeşili Taşlı İnce Yüzük', 'Yüzük', 'Zümrüt Kesim',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/a/ad/Emerald_ring_photo_by_Somma.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/a/ad/Emerald_ring_photo_by_Somma.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/0/05/Emerald_ring_1.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'Kırmızı Yakut Taşlı Altın Kaplama Yüzük', 'Yüzük', 'Yakut',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/2/28/Poetry_-_gold_ring_with_large_ruby_-_cropped.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/2/28/Poetry_-_gold_ring_with_large_ruby_-_cropped.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/8/81/Poetry_-_gold_ring_with_large_ruby.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/b/b6/Gold_ring_with_a_ruby.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'Yuvarlak Kesim Yakut Taşlı Yüzük', 'Yüzük', 'Yakut',
 ...
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/1/1a/Ruby_ring_photo_by_stevendepolo.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/6/66/Ruby_ring_photo_by_bfishadow.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/b/b4/Ruby_ring_photo_by_by_bfishadow.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'İkiz Bantlı Sade Yüzük', 'Yüzük', 'Sade',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/6/6a/2012_T456_A_Post_Medieval_gold_finger_ring_%28FindID_568813%29.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/6/6a/2012_T456_A_Post_Medieval_gold_finger_ring_%28FindID_568813%29.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/1/1a/Undated_plain_gold_band_or_finger_ring_%28FindID_176128%29.jpg'
...
('b2b2b2b2-0006-4000-8000-000000000006', 'Lületaşı Detaylı Sultani Tesbih', 'Tesbih', 'Lületaşı',
 ...
 'https://upload.wikimedia.org/wikipedia/commons/4/40/Mineraly.sk_-_sepiolit.jpg',
 ARRAY[
   'https://upload.wikimedia.org/wikipedia/commons/4/40/Mineraly.sk_-_sepiolit.jpg',
   'https://upload.wikimedia.org/wikipedia/commons/c/cf/Tasbih_or_prayer_beads.jpg'
